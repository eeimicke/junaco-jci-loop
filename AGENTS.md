...
- Keine JCI-Kernelemente, Graphobjekte, Beziehungen oder Kardinalitäten stillschweigend erfinden, entfernen oder umdeuten.
- Vor einer semantischen Änderung die betroffenen Elemente, Beziehungen und Regeln benennen.
- Konflikte mit der kanonischen Spezifikation melden, bevor das Modell verändert wird.
- Auswirkungen auf `CiV`, `PiF2`, `PiF1s`, `PiF1t`, `PiF1o`, `RaN`, `RoF`, `ERoF`, `SYNC` und `PiH` prüfen.
- Die Rückverfolgbarkeit von operativer Arbeit zu `CiV` erhalten.
- Menschliche Modellentscheidungen nicht durch automatische Annahmen ersetzen.

## Änderungsdisziplin

- Änderungen in einem eigenen Branch und über einen Pull Request vornehmen.
